...
public final class ScreenUtils {
    ...
    public static boolean isLandscape() {
        return MyApp.app.getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) MyApp.app.getSystemService(Context.KEYGUARD_SERVICE);
